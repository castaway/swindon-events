use utf8;
package Mobilizon::Schema::Result::ApplicationToken;
...
=head1 TABLE: C<application_tokens>

=cut

__PACKAGE__->table("application_tokens");
...
=head2 id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'application_tokens_id_seq'
...
=head2 C<application_tokens_user_id_application_id_index>
...
__PACKAGE__->add_unique_constraint(
  "application_tokens_user_id_application_id_index",
...
Related object: L<Mobilizon::Schema::Result::Application>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NQIcoLTHY8FYBtlJSlflHg
