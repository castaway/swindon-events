use utf8;
package Mobilizon::Schema::Result::GeographyColumn;
...
Mobilizon::Schema::Result::GeographyColumn
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:H8/KMFM1KVgUc/LaI1H1Hg
