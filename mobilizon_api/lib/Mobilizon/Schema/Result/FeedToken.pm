use utf8;
package Mobilizon::Schema::Result::FeedToken;
...
=head1 TABLE: C<feed_tokens>

=cut

__PACKAGE__->table("feed_tokens");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:H6UzKCc7YgvIcEDR3K8o9A
