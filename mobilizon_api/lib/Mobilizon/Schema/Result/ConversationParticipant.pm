use utf8;
package Mobilizon::Schema::Result::ConversationParticipant;
...
=head1 TABLE: C<conversation_participants>

=cut

__PACKAGE__->table("conversation_participants");
...
=head2 id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'conversation_participants_id_seq'
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ZuOTHyN62gj1+FS2W0FDqg
