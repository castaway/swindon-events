use utf8;
package Mobilizon::Schema::Result::GeometryColumn;
...
Mobilizon::Schema::Result::GeometryColumn
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Je3bkGHa48wkeMdhe3qBtA
