use utf8;
package Mobilizon::Schema::Result::EventContact;
...
=head1 TABLE: C<event_contacts>

=cut

__PACKAGE__->table("event_contacts");
...
__PACKAGE__->set_primary_key("event_id", "actor_id");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:V5fjgAn2gVTozPck67qQ9w
