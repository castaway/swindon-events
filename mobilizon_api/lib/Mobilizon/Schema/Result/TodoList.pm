use utf8;
package Mobilizon::Schema::Result::TodoList;
...
__PACKAGE__->add_unique_constraint("todo_lists_url_index", ["url"]);
...
__PACKAGE__->has_many(
  ...
  { "foreign.todo_list_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);


# Created by DBIx::Class::Schema::Loader v0.07053 @ 2025-04-05 14:20:49
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tf/H+YG+lPRIMaDOrtFnWQ
